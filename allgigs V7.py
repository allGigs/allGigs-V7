...
def categorize_location(location: str, rate: str = None, company: str = None, source: str = None, title: str = None, summary: str = None) -> dict:
    ...
    if is_remote and not remote_region:
        ...
        # Check company context for French companies
        if not remote_region and company and not pd.isna(company):
            company_clean = str(company).lower().strip()
            french_companies = ['orange', 'total', 'bnp paribas', 'société générale', 'crédit agricole', 'carrefour', 'psa', 'renault', 'airbus', 'danone', 'l\'oréal', 'lvmh', 'kering', 'hermes', 'saint-gobain']
            if any(french_company in company_clean for french_company in french_companies):
                remote_region = 'french'
...
def classify_job_industry(title, summary=''):
    ...
    # Handle work arrangement tags
    skip_patterns = ['zzp', 'aanbevolen', 'tijdelijk', 'fulltime', 'parttime']
    if any(pattern in text and len(text.split()) <= 3 for pattern in skip_patterns):
        return 'Work Arrangement Tags'
    
    # Industry keywords (expanded)
    keywords = {
        'IT & Software Development': ['developer', 'programmer', 'software', 'architect', 'développeur', 'développeuse', 'programmeur', 'programmeuse', 'java', 'python', 'react', 'javascript', 'typescript', 'node.js', 'angular', 'vue', 'php', 'c#', 'c++', 'ruby', 'go', 'swift', 'kotlin', 'flutter', 'dart', 'scala', 'rust', 'perl', '.net', 'html', 'css', 'bootstrap', 'jquery', 'laravel', 'django', 'spring', 'express', 'mongodb', 'postgresql', 'mysql', 'redis', 'docker', 'kubernetes', 'aws', 'azure', 'devops', 'frontend', 'backend', 'fullstack', 'mobile', 'ios', 'android', 'web development', 'app development', 'test engineer', 'iam specialist', 'test', 'platform', 'api', 'microservices', 'cloud', 'serverless', 'automation', 'delivery professional'],
        'Data & Analytics': ['data analyst', 'data scientist', 'data engineer', 'analyst', 'business intelligence', 'bi analyst', 'bi developer', 'sql', 'analytics', 'machine learning', 'tableau', 'power bi', 'excel', 'r programming', 'r language', 'sas', 'spss', 'hadoop', 'spark', 'tensorflow', 'pytorch', 'artificial intelligence', 'ai engineer', 'ai specialist', 'statistics', 'reporting', 'dashboard', 'etl', 'nlp'],
        'Finance & Accounting': ['controller', 'accountant', 'finance', 'financial', 'fec', 'boekhouder', 'administrateur', 'treasury', 'audit', 'auditor', 'crediteuren', 'debiteuren', 'salarisadministratie', 'cfo', 'bookkeeping', 'payroll', 'tax', 'billing', 'budget', 'kredietacceptant', 'inkomen'],
        'Project Management': ['project manager', 'scrum', 'agile', 'projectleider', 'program manager', 'pmo', 'project coordinator', 'product owner', 'scrum master', 'kanban', 'waterfall', 'milestone', 'delivery', 'planning'],
        'Creative & Media': ['photo', 'video', 'creative', 'editor', 'content', 'motion', 'graphics', 'motion graphics', 'animation', 'design', 'designer', 'ux', 'ui', 'graphic design', 'web design', 'visual design', 'illustrator', 'photoshop', '3d', 'adobe', 'ux-writer', 'branding', 'photography', 'videography', 'cinematography', 'storytelling', '3d graphic'],
        'Engineering': ['elektrotechniek', 'electrical engineering', 'mechanical engineering', 'civil engineering', 'engineer', 'ingenieur', 'technical', 'technisch', 'mechanical', 'electrical', 'civil', 'process engineer', 'quality engineer', 'systems engineer', 'project engineer', 'design engineer', 'maintenance engineer', 'installation engineer', 'werktuigbouwkunde', 'bouwkunde', 'techniek', 'monteur', 'mechanic', 'technician', 'bouwloket', 'bouwtechnische', 'manufacturing', 'production', 'automation', 'robotics', 'cad', 'bouwkundig tekenaar', 'schilder'],
        'Food & Agriculture': ['food', 'voedsel', 'food auditor', 'food safety', 'agriculture', 'landbouw', 'farming', 'food industry', 'food production', 'food quality', 'food inspector', 'agricultural', 'agrarisch', 'voedingsmiddelen', 'horeca', 'restaurant', 'chef', 'cook', 'kok', 'catering', 'food delivery specialist', 'kitchen', 'baking', 'nutrition', 'fishery', 'livestock'],
        'Education & Training': ['teacher', 'leraar', 'docent', 'instructor', 'taalinstructor', 'language instructor', 'education', 'onderwijs', 'training', 'tutor', 'professor', 'lecturer', 'coach', 'mentor', 'cursus', 'les', 'lesson', 'school', 'university', 'universiteit', 'college', 'academy', 'academie', 'educational', 'pedagoog', 'pedagogisch', 'curriculum', 'pedagogy', 'e-learning', 'workshop', 'facilitator', 'portfoliobegeleider', 'afstudeerbegeleider', 'studiecoach'],
        'Customer Service & Support': ['klantenservice', 'customer service', 'customer support', 'helpdesk', 'support', 'klantondersteuning', 'call center', 'callcenter', 'telefonist', 'receptionist', 'customer care', 'client service', 'service desk', 'technical support', 'gebruikersondersteuning', 'klantbegeleiding', 'chat', 'ticket', 'complaint', 'assistance', 'retention', 'customer'],
        'Writing & Content': ['tekst', 'writer', 'schrijver', 'content writer', 'copywriter', 'tekstschrijver', 'redacteur', 'editor', 'journalist', 'blogger', 'content creator', 'content specialist', 'technical writer', 'ghostwriter', 'proofreader', 'translator', 'vertaler', 'content manager', 'editorial', 'redactioneel', 'writing', 'schrijven', 'publishing', 'manuscript', 'documentation', 'proposal', 'script'],
        'HR & Recruitment': ['hr manager', 'hr specialist', 'hr officer', 'hr consultant', 'hr business partner', 'human resources', 'recruitment', 'recruiter', 'corporate recruiter', 'talent acquisition', 'hr adviseur', 'recruitment consultant', 'headhunter', 'talent manager', 'personeelsadviseur', 'wervingsadviseur', 'talent scout', 'people & culture', 'jobcoach', 'leader acquisition', 'onboarding', 'offboarding', 'compensation', 'benefits', 'employee relations', 'salarisadministrateur', 'coach'],
        'Healthcare & Medical': ['arts', 'basis arts', 'dokter', 'verpleegkundige', 'nurse', 'medical', 'healthcare', 'zorg', 'medisch', 'tandarts', 'fysiotherapeut', 'psycholoog', 'apotheker', 'specialist', 'huisarts', 'geneeskunde', 'farmaceutisch', 'klinisch', 'ziekenhuis', 'praktijk', 'gezondheidszorg', 'dierenwelzijn', 'verzorger', 'therapist', 'counselor', 'paramedic', 'radiologist', 'surgeon', 'zorgcoördinator'],
        'Marketing & Communications': ['marketing', 'community', 'social media', 'communications', 'content marketing', 'digital marketing', 'community manager', 'social media manager', 'marketeer', 'seo', 'sem', 'communicatieprofessional', 'advertising', 'pr', 'public relations', 'campaign', 'brand', 'google tag manager'],
        'Consulting': ['consultant', 'advisory', 'interim', 'adviseur', 'interim manager', 'management consultant', 'strategy consultant', 'business consultant', 'transitiemanager', 'trainer', 'advisor', 'expertise', 'specialist', 'freelance', 'contractor'],
        'Government & Public Sector': ['gemeente', 'overheid', 'publieke', 'burgerzaken', 'ministerie', 'provincie', 'rijksoverheid', 'beleid', 'beleidsadviseur', 'beleidsmedewerker', 'omgevingsprogramma', 'plantoetser', 'kwartiermaker', 'consulent', 'buurtsportcoach', 'public sector', 'civil service', 'administration', 'regulatory', 'compliance', 'programmamanager'],
        'Sales & Business Development': ['sales', 'business development', 'account manager', 'commercieel', 'verkoop', 'sales manager', 'business developer', 'accountmanager', 'commercieel medewerker', 'verkoper', 'key account manager', 'revenue', 'leads', 'prospects', 'closing', 'partnership', 'verkooppartner', 'commercial'],
        'Security & Safety': ['security guard', 'bewaker', 'beveiliger', 'portier', 'nachtportier', 'security officer', 'safety officer', 'veiligheid', 'security', 'beveiliging', 'wachter', 'surveillant', 'security manager', 'fire safety', 'emergency', 'patrol', 'access control', 'risk management', 'cybersecurity', 'cyber security', 'information security', 'it security', 'safety']
    }
        ...
        for std_col, src_col_mapping_value in mapping.items():
            if std_col in result.columns and isinstance(src_col_mapping_value, str) and not result[std_col].empty:
                ...
                is_special_case = (
                    ...
                    std_col == 'Source' or \
                    std_col == 'Hours' or \
                    std_col == 'Type source'  # Type source field values are always intentional literals
                )
